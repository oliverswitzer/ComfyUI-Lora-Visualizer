...
class TestLoRAPromptComposerNode(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.folder_patcher = patch('folder_paths.get_folder_paths', return_value=[self.fixtures_path])
    ...
    def test_compose_prompt_returns_llm_output(self):
        ...
        with patch.object(self.node, '_ensure_model_available', return_value=None):
            ...
            with patch.object(self.node, '_call_ollama', return_value=expected_prompt) as call_mock:
    ...
    def test_compose_prompt_uses_default_model(self):
        ...
        with patch.object(self.node, '_ensure_model_available', side_effect=fake_ensure):
            ...
            with patch.object(self.node, '_call_ollama', return_value="prompt"):
                ...
                _ = self.node.compose_prompt(num_wan_loras=1, num_image_loras=1, model_name=None)
